{{-- resources/views/admin/sales_returns/create.blade.php --}}
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('messages.create_new') }} {{ __('messages.sales_returns') }}</h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('admin.sales-returns.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('admin.sales-returns.index') }}" class="btn btn-secondary">{{ __('messages.cancel') }}</a>
                            </div>
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" name="products[${index}][unit_price]" class="form-control unit-price-input"
                               required value="${(orderProduct.total_price_after_tax / orderProduct.quantity).toFixed(2)}" onchange="updateTotal()">
                    </div>
                    <div class="col-md-2">
