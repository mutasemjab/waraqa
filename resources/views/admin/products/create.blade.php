                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="category_id" class="form-label">{{ __('messages.provider') }}</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('selling_price') is-invalid @enderror"
                                           id="selling_price" name="selling_price" value="{{ old('selling_price') }}" step="any" min="0" required>
                                    @error('selling_price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>

                                <div class="mb-3">
                                    <label for="tax" class="form-label">{{ __('messages.Tax_Percentage') }}</label>
                                    <input type="number" class="form-control"
                                           id="tax" name="tax" value="15" step="any" min="0">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    <label for="images" class="form-label">{{ __('messages.Upload_Image') }}</label>
                                    <input type="file" class="form-control @error('photo') is-invalid @enderror" 
                                           id="images" name="photo">
