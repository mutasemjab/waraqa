    ...
    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex align-items-end">
                                <div class="btn-group w-100">
                                    ...
                                    <button type="button" class="btn btn-warning" id="displayOptionsBtn" data-toggle="modal" data-target="#displayOptionsModal">
                                        <i class="fas fa-sliders-h"></i> خيارات العرض
                                    </button>
                                    <button type="button" class="btn btn-success" id="exportBtn" data-toggle="modal" data-target="#exportOptionsModal">
        ...
        <div class="row mb-4 distribution-section printable-section" style="display:block;">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h3 class="card-title"><i class="fas fa-boxes"></i> التوزيع على المكتبات</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">عدد المكتبات</span>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي الكمية الموزعة</span>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h3 class="card-title"><i class="fas fa-chart-bar"></i> المبيعات حسب المكتبة</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي المباع</span>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-danger text-white">
                        <h3 class="card-title"><i class="fas fa-undo"></i> المردود</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي المرتجع</span>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي قيمة المردود</span>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-warning text-white">
                        <h3 class="card-title"><i class="fas fa-money-bill-wave"></i> دفعات المكتبات</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي المدفوع</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي المتبقي</span>
                            ...
                            <div class="col-md-4">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><span id="sales-place-total-revenue">0.00</span> <x-riyal-icon /></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info text-white">
                        <h3 class="card-title"><i class="fas fa-cubes"></i> الرصيد المتبقي</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">إجمالي الكمية المتبقية</span>
...
<div class="modal fade" id="displayOptionsModal" tabindex="-1" role="dialog" aria-labelledby="displayOptionsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted mb-3">اختر الأقسام التي تريد عرضها</p>
                ...
                <div class="row">
                        ...
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_provider_info" data-section="provider_info" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_provider_info">
                                        <i class="fas fa-user"></i> معلومات المورد
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_statistics" data-section="statistics" checked>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_products" data-section="products" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_products">
                                        <i class="fas fa-box"></i> جدول المنتجات
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_purchases" data-section="purchases" checked>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_distribution" data-section="distribution" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_distribution">
                                        <i class="fas fa-boxes"></i> التوزيع على المكتبات
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_sales" data-section="sales" checked>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_refunds" data-section="refunds" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_refunds">
                                        <i class="fas fa-undo"></i> المردود
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_sellers_payments" data-section="sellers_payments" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_sellers_payments">
                                        <i class="fas fa-money-bill-wave"></i> دفعات المكتبات
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_stock_balance" data-section="stock_balance" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_stock_balance">
                                        <i class="fas fa-cubes"></i> الرصيد المتبقي
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input display-section-toggle" id="display_book_requests" data-section="book_requests" checked>
                                    <label class="custom-control-label font-weight-bold" for="display_book_requests">
                                        <i class="fas fa-book"></i> طلبات الكتب
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="border-top pt-3">
                    <div class="btn-group btn-group-sm w-100">
                        <button type="button" class="btn btn-outline-primary flex-grow-1" id="selectAllDisplay">
                            <i class="fas fa-check-double"></i> اختر الكل
                        </button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle" id="export_provider_info" checked data-section="provider_info">
                            ...
                            <div class="card-body" id="provider_info_options">
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_provider_name" name="export_options[]" value="provider_name" checked>
                                    <label class="custom-control-label" for="export_provider_name">{{ __('messages.name') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_provider_email" name="export_options[]" value="provider_email" checked>
                                    <label class="custom-control-label" for="export_provider_email">{{ __('messages.email') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_provider_phone" name="export_options[]" value="provider_phone" checked>
                                    <label class="custom-control-label" for="export_provider_phone">{{ __('messages.phone') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_provider_country" name="export_options[]" value="provider_country" checked>
                                    <label class="custom-control-label" for="export_provider_country">{{ __('messages.country') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_provider_address" name="export_options[]" value="provider_address" checked>
                                    <label class="custom-control-label" for="export_provider_address">{{ __('messages.address') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle" id="export_statistics" checked data-section="statistics">
                            ...
                            <div class="card-body" id="statistics_options">
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_total_products" name="export_options[]" value="total_products" checked>
                                    <label class="custom-control-label" for="export_total_products">{{ __('messages.total_products') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_total_quantity" name="export_options[]" value="total_quantity" checked>
                                    <label class="custom-control-label" for="export_total_quantity">{{ __('messages.total_quantity') }}</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input export-option" id="export_total_revenue" name="export_options[]" value="total_revenue" checked>
                                    <label class="custom-control-label" for="export_total_revenue">{{ __('messages.total_revenue') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle" id="export_products" checked data-section="products">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle" id="export_purchases" checked data-section="purchases">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle export-option" id="export_distribution" name="export_options[]" value="distribution" checked data-section="distribution">
                            ...
                            <div class="card-body" id="distribution_options">
                                <small class="text-muted">توزيع المنتجات على المكتبات</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle export-option" id="export_sales" name="export_options[]" value="sales" checked data-section="sales">
                            ...
                            <div class="card-body" id="sales_options">
                                <small class="text-muted">المبيعات حسب المكتبة</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle export-option" id="export_refunds" name="export_options[]" value="refunds" checked data-section="refunds">
                            ...
                            <div class="card-body" id="refunds_options">
                                <small class="text-muted">المبيعات المرتجعة</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle export-option" id="export_sellers_payments" name="export_options[]" value="sellers_payments" checked data-section="sellers_payments">
                                    <label class="custom-control-label font-weight-bold" for="export_sellers_payments">
                                        <i class="fas fa-money-bill-wave"></i> دفعات المكتبات
                                    </label>
                                </div>
                            </div>
                            <div class="card-body" id="sellers_payments_options">
                                <small class="text-muted">ملخص دفعات المكتبات</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle export-option" id="export_stock_balance" name="export_options[]" value="stock_balance" checked data-section="stock_balance">
                            ...
                            <div class="card-body" id="stock_balance_options">
                                <small class="text-muted">الكميات المتبقية في المستودع</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header bg-light">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input section-toggle" id="export_book_requests" checked data-section="book_requests">
                            ...
                            <div class="card-body" id="book_requests_options">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="custom-control custom-checkbox mb-2">
                                            <input type="checkbox" class="custom-control-input export-option" id="export_book_stats" name="export_options[]" value="book_stats" checked>
                                            <label class="custom-control-label" for="export_book_stats">{{ __('messages.book_requests_stats') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="custom-control custom-checkbox mb-2">
                                            <input type="checkbox" class="custom-control-input export-option" id="export_book_details" name="export_options[]" value="book_details" checked>
                                            <label class="custom-control-label" for="export_book_details">{{ __('messages.book_requests_details') }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    const trans = {
        ...
        purchaseNumber: "{{ __('messages.purchase_number') ?? 'رقم الفاتورة' }}",
        date: "{{ __('messages.date') ?? 'التاريخ' }}",
        totalAmount: "{{ __('messages.total_amount') ?? 'المبلغ الإجمالي' }}",
        tax: "{{ __('messages.tax') ?? 'الضريبة' }}",
        totalWithTax: "{{ __('messages.total_with_tax') ?? 'الإجمالي مع الضريبة' }}",
        status: "{{ __('messages.status') ?? 'الحالة' }}",
        requestedQuantity: "{{ __('messages.requested_quantity') ?? 'الكمية المطلوبة' }}",
        availableQuantity: "{{ __('messages.available_quantity') ?? 'الكمية المتاحة' }}",
        price: "{{ __('messages.price') ?? 'السعر' }}",
        notes: "{{ __('messages.notes') ?? 'ملاحظات' }}",
        noData: "{{ __('messages.no_data_available') ?? 'لا توجد بيانات' }}",
        warehouse: "{{ __('messages.warehouse') ?? 'المكتبة' }}",
        quantity: "{{ __('messages.quantity') ?? 'الكمية' }}",
        revenue: "{{ __('messages.revenue') ?? 'الإيرادات' }}",
        amount: "{{ __('messages.amount') ?? 'المبلغ' }}"
    };
    ...
    $('#applyDisplayOptions').on('click', function() {
        ...
        Swal.fire({
            icon: 'success',
            title: 'تم',
            text: 'تم تطبيق خيارات العرض بنجاح',
            timer: 1500,
    ...
    function loadDistributionData(providerId) {
        ...
        $.ajax({
            url: '{{ route("admin.reports.providers.distribution", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            data: {
                from_date: fromDate,
                to_date: toDate
            ...
            error: function(xhr) {
                ...
                $('#distributionTableContainer').html('<p class="text-center text-danger">حدث خطأ أثناء تحميل البيانات</p>');
            }
        });
    }
    ...
    function populateDistributionTable(data) {
        if (data.length === 0) {
            $('#distributionTableContainer').html('<p class="text-center text-muted">لا توجد بيانات</p>');
            return;
        }
    ...
    function loadSalesByWarehouse(providerId) {
        ...
        $.ajax({
            url: '{{ route("admin.reports.providers.salesByWarehouse", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            data: {
                from_date: fromDate,
                to_date: toDate
            ...
            success: function(response) {
                if (response.success && response.sales) {
                    ...
                    $('#sales-total-revenue').text(parseFloat(response.summary.total_revenue || 0).toFixed(2));
                    populateSalesTable(response.sales);
                }
            },
            error: function(xhr) {
                console.error('Error loading sales data:', xhr);
                $('#salesTableContainer').html('<p class="text-center text-danger">حدث خطأ أثناء تحميل البيانات</p>');
            }
        });
    }
    ...
    function populateSalesTable(data) {
        if (data.length === 0) {
            $('#salesTableContainer').html('<p class="text-center text-muted">لا توجد بيانات</p>');
            return;
        }
    ...
    function loadRefundsData(providerId) {
        ...
        $.ajax({
            url: '{{ route("admin.reports.providers.refunds", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            data: {
                from_date: fromDate,
                to_date: toDate
            ...
            success: function(response) {
                if (response.success && response.refunds) {
                    ...
                    $('#refunds-total-amount').text(parseFloat(response.summary.total_amount || 0).toFixed(2));
                    populateRefundsTable(response.refunds);
                }
            },
            error: function(xhr) {
                console.error('Error loading refunds data:', xhr);
                $('#refundsTableContainer').html('<p class="text-center text-danger">حدث خطأ أثناء تحميل البيانات</p>');
            }
        });
    }
    ...
    function populateRefundsTable(data) {
        if (data.length === 0) {
            $('#refundsTableContainer').html('<p class="text-center text-muted">لا توجد بيانات</p>');
            return;
        }
    ...
    function loadSellersPaymentsData(providerId) {
        $.ajax({
            url: '{{ route("admin.reports.providers.sellersPayments", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            success: function(response) {
                if (response.success && response.payments) {
                    $('#payments-total-amount').text(parseFloat(response.summary.total_orders_amount || 0).toFixed(2));
                    $('#payments-total-paid').text(parseFloat(response.summary.total_paid || 0).toFixed(2));
                    $('#payments-total-remaining').text(parseFloat(response.summary.total_remaining || 0).toFixed(2));
                    populatePaymentsTable(response.payments);
                }
            },
            error: function(xhr) {
                console.error('Error loading payments data:', xhr);
                $('#sellersPaymentsTableContainer').html('<p class="text-center text-danger">حدث خطأ أثناء تحميل البيانات</p>');
            }
        });
    }
    ...
    function populatePaymentsTable(data) {
        if (data.length === 0) {
            $('#sellersPaymentsTableContainer').html('<p class="text-center text-muted">لا توجد بيانات</p>');
            return;
        }
        ...
        data.forEach(function(item, index) {
            const statusBadge = item.payment_status === 'مسدد'
            ...
            html += `
                <tr>
                    ...
                    <td>${statusBadge}</td>
                    <td>${new Date(item.last_order_date).toLocaleDateString('ar-SA')}</td>
                </tr>
            `;
        });
    ...
    function loadStockBalanceData(providerId) {
        $.ajax({
            url: '{{ route("admin.reports.providers.stockBalance", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            success: function(response) {
            ...
            error: function(xhr) {
                ...
                $('#stockBalanceTableContainer').html('<p class="text-center text-danger">حدث خطأ أثناء تحميل البيانات</p>');
            }
        });
    }
    ...
    function populateStockBalanceTable(data) {
        if (data.length === 0) {
            $('#stockBalanceTableContainer').html('<p class="text-center text-muted">لا توجد بيانات</p>');
            return;
        }
    ...
    function loadSalesByPlaceData(providerId) {
        ...
        $.ajax({
            url: '{{ route("admin.reports.providers.salesByPlace", ":id") }}'.replace(':id', providerId),
            method: 'GET',
            data: {
                from_date: fromDate,
                to_date: toDate
            ...
            success: function(response) {
                if (response.success && response.sales_by_place) {
                    ...
                    $('#sales-place-total-revenue').text(parseFloat(response.summary.total_revenue || 0).toFixed(2));
                    populateSalesByPlaceTable(response.sales_by_place);
                }
            },
            error: function(xhr) {
                console.error('Error loading sales by place data:', xhr);
                $('#salesByPlaceTableContainer').html('<p class="text-center text-danger">{{ __("messages.error_loading_data") }}</p>');
            }
        });
    }
    ...
    function populateSalesByPlaceTable(data) {
        if (data.length === 0) {
            $('#salesByPlaceTableContainer').html('<p class="text-center text-muted">{{ __("messages.no_data_available") }}</p>');
            return;
        }
