...
@section('title')
{{ __('messages.purchase_returns_report') }}
@endsection
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title card_title_center">{{ __('messages.purchase_returns_report') }}</h3>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row mb-4 no-print">
            <div class="col-md-12">
                <div class="card card-default">
                    ...
                    <form method="GET" action="{{ route('admin.reports.purchaseReturns') }}" class="form-horizontal">
                        <div class="card-body">
                            <div class="row">
                                <!-- From Date -->
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    <div class="form-group" style="width: 100%;">
                                        <a href="{{ route('admin.reports.purchaseReturns') }}" class="btn btn-secondary btn-block">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $return->purchase->number ?? '-' }}</td>
                                        <td>{{ $return->provider->name ?? '-' }}</td>
                                ...
                                <tfoot>
                                    <tr class="font-weight-bold">
                                        <td colspan="6" class="text-center">{{ __('messages.Total') }}</td>
        ...
        <!-- Statistics by Status and Provider -->
        ...
        <!-- Statistics by Warehouse and Product -->
