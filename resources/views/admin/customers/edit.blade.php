...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('messages.Edit_Customer') }}</h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="activate" name="activate">
                                <option value="1" {{ old('activate', $customer->activate) == 1 ? 'selected' : '' }}>{{ __('messages.Active') }}</option>
                                <option value="2" {{ old('activate', $customer->activate) == 2 ? 'selected' : '' }}>{{ __('messages.Inactive') }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-3" id="image-preview">
                                @if($customer->photo)
                                <img src="{{ asset('assets/admin/uploads/' . $customer->photo) }}" alt="{{ $customer->name }}" class="img-fluid img-thumbnail" style="max-height: 200px;">
                                @endif
                            </div>
                        </div>
                    </div>
