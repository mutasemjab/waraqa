{{-- resources/views/admin/purchase_returns/index.blade.php --}}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>{{ __('messages.purchase_returns') }}</h4>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $return->purchase->purchase_number ?? 'N/A' }}</td>
                                    <td>{{ $return->provider->name ?? 'N/A' }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.purchase-returns.show', $return) }}" class="btn btn-sm btn-info" title="{{ __('messages.view') }}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.purchase-returns.edit', $return) }}" class="btn btn-sm btn-warning" title="{{ __('messages.edit') }}">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.purchase-returns.destroy', $return) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
