            ...
            <table class="table table-bordered" id="products_table">
                ...
                <tbody>
                    <?php $__currentLoopData = $noteVoucher->voucherProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $voucherProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><input type="text" class="form-control barcode-input" name="products[<?php echo e($key); ?>][barcode]" /></td>
                            <td><input type="text" class="form-control product-search" name="products[<?php echo e($key); ?>][name]" value="<?php echo e($voucherProduct->name_ar); ?>" /></td>
                           
                            <td><input type="number" class="form-control" name="products[<?php echo e($key); ?>][quantity]" value="<?php echo e($voucherProduct->pivot->quantity); ?>" /></td>
                            <?php if($noteVoucher->noteVoucherType->have_price == 1): ?>
                                <td><input type="number" class="form-control" name="products[<?php echo e($key); ?>][purchasing_price]" value="<?php echo e($voucherProduct->pivot->purchasing_price); ?>" step="any"/></td>
                            <?php endif; ?>
                            <td><input type="text" class="form-control" name="products[<?php echo e($key); ?>][note]" value="<?php echo e($voucherProduct->pivot->note); ?>" /></td>
    ...
    $(document).ready(function() {
        ...
        $('#add_row').on('click', function() {
            $('#products_table tbody').append(`
                <tr>
                    <td><input type="text" class="form-control barcode-input" name="products[${rowIdx}][barcode]" /></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nasher\resources\views/admin/noteVouchers/edit.blade.php ENDPATH**/ ?>