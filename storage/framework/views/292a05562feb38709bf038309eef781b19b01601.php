...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center"> <?php echo e(__('messages.Add_New')); ?> <?php echo e(__('messages.warehouses')); ?> </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group text-center">
                            ...
                            <a href="<?php echo e(route('warehouses.index')); ?>" class="btn btn-sm btn-danger"><?php echo e(__('messages.Cancel')); ?></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nasher\resources\views/admin/warehouses/create.blade.php ENDPATH**/ ?>