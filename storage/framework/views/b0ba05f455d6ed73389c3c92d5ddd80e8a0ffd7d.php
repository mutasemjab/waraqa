                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo e(old('name', $provider->name)); ?>" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="country_id"><?php echo e(__('messages.country')); ?> <span class="text-danger">*</span></label>
                            <select class="form-control" id="country_id" name="country_id" required>
                                <option value=""><?php echo e(__('messages.select_country')); ?></option>
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($country->id); ?>" <?php echo e(old('country_id', $provider->country_id) == $country->id ? 'selected' : ''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-3" id="image-preview">
                                ...
                                <img src="<?php echo e(asset('assets/admin/uploads/' . $provider->photo)); ?>" class="img-fluid img-thumbnail" style="max-height: 200px;">
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nasher\resources\views/admin/providers/edit.blade.php ENDPATH**/ ?>