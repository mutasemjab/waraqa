...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('messages.provider_dashboard')); ?> - <?php echo e(config('app.name')); ?></title>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="logo">
                ...
                <span><?php echo e(__('messages.provider_panel')); ?></span>
            </div>
        </div>
        
        <nav class="nav-menu">
            <div class="nav-item">
                <a href="<?php echo e(route('provider.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('provider.dashboard') ? 'active' : ''); ?>">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('provider.products')); ?>" class="nav-link <?php echo e(request()->routeIs('provider.products*') ? 'active' : ''); ?>">
                    <i class="fas fa-box"></i>
                    <span><?php echo e(__('messages.my_products')); ?></span>
                </a>
            </div>
            
            <div class="nav-item">
                <a href="<?php echo e(route('provider.orders')); ?>" class="nav-link <?php echo e(request()->routeIs('provider.orders*') ? 'active' : ''); ?>">
                    <i class="fas fa-clipboard-list"></i>
                    <span><?php echo e(__('messages.orders')); ?></span>
            ...
            <div class="nav-item">
                <a href="#" class="nav-link">
                    ...
                    <span><?php echo e(__('messages.analytics')); ?></span>
                </a>
            </div>
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('provider.profile')); ?>" class="nav-link <?php echo e(request()->routeIs('provider.profile*') ? 'active' : ''); ?>">
            ...
            <div class="navbar-right">
                <div class="user-dropdown">
                    <div class="user-info" data-bs-toggle="dropdown">
                        <img src="<?php echo e(auth('provider')->user()->photo_url); ?>" alt="Provider" class="user-avatar">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('provider.profile')); ?>" class="dropdown-item">
...
</html><?php /**PATH C:\xampp\htdocs\nasher\resources\views/layouts/provider.blade.php ENDPATH**/ ?>